...
INSERT INTO _DATABASE_.`tb_entity` (`objid`, `name`, `type`) VALUES (1, 'Hard Rock', 'Restaurant');
INSERT INTO _DATABASE_.`tb_entity` (`objid`, `name`, `type`) VALUES (2, 'Pizza Hut', 'Restaurant');
INSERT INTO _DATABASE_.`tb_entity` (`objid`, `name`, `type`) VALUES (3, 'Green Life Restaurant', 'Restaurant');
...
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (3, 1, 'M', 'O', 0);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (4, 1, 'F', 'Y', 1);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (5, 1, 'F', 'A', -1);
...
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (8, 2, 'M', 'A', 2);
...
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (11, 2, 'F', 'A', 1);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (12, 2, 'F', 'O', 3);

INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (13, 3, 'M', 'Y', 0);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (14, 3, 'M', 'A', 0);
...
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (17, 3, 'F', 'A', 1);
...
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (27, 5, 'M', 'O', 3);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (28, 5, 'F', 'Y', 3);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (29, 5, 'F', 'A', 4);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (30, 5, 'F', 'O', 3);

INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (31, 6, 'M', 'Y', 3);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (32, 6, 'M', 'A', 3);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (33, 6, 'M', 'O', 1);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (34, 6, 'F', 'Y', 3);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (35, 6, 'F', 'A', 2);
INSERT INTO _DATABASE_.`tb_score` (`objid`, `metadata_id`, `gender`, `age`, `score`) VALUES (36, 6, 'F', 'O', 1);
